  ...
  return (
    <>
      <div className="space-y-6">
        ...
        <div className="min-w-0 overflow-hidden rounded-2xl border border-slate-800 bg-slate-900/50 shadow-xl">
          <div className="flex items-center gap-3 border-b border-slate-800 px-4 py-4 sm:px-6">
                ...
                {recetas.map((receta) => (
                  <li key={receta.id} className="min-w-0">
                    <button
                      ...
                      className="flex w-full min-w-0 max-w-full gap-3 overflow-hidden rounded-xl border border-slate-800 bg-slate-950/50 p-4 text-left transition-colors hover:border-cyan-500/30 hover:bg-slate-900/80 focus:outline-none focus:ring-2 focus:ring-cyan-500/20 sm:gap-4"
                    >
                      {receta.imagenUrl ? (
                        <img
